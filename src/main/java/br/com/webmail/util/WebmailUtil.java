...
public class WebmailUtil {
	...
	public static final String AUDITORIALOGIN = "AUDITORIALOGIN";
	...
	public static AuditoriaLogin getAuditoriaLogin(){
		Object auditoria = SecurityUtils.getSubject().getSession().getAttribute(AUDITORIALOGIN);
		if(auditoria != null){
			return (AuditoriaLogin) auditoria;
		}
		throw new AutenticacaoException("Nenhuma sessão disponível.");
	}
}
